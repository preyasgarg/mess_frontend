...
const FeedBack=()=>{
    ...
    const handleRating2 = (newRating) => {
      ...
      const  postdatatoserver= async (data)=>{
        ...
        axios.put("http://c228-103-156-19-229.ngrok.io/postrating", {
        "id": 1,
    ...
    return(
      <>
       <div>
        ...
        {/* <Emojisliders/> */}
        <RatingComponent brating={brating} onClick={handleRating1} />
        <h2> Rate Your Lunch</h2>
        <div>
        <RatingComponent lrating={lrating} onClick={handleRating2} />
      </div>
        <h2> Rate Your Dinner</h2>
        <RatingComponent drating={drating} onClick={handleRating3} />
        <br/>
        <br/>
